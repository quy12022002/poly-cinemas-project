    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Cập nhật Thanh Toán</h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        value="{{$payment->name}}" placeholder="Nhập tên phương thức thanh toán">
                                        @error("name")
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        placeholder="Nhập mô tả thanh toán">{{ $payment->description }}</textarea>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
